...
//        Tags { "RenderType"="Transparent" "Queue" = "Transparent" }
        ...
        Pass{
            ...
            varyings vert (uint id : SV_VertexID){
                ...
                o.debug =  (normalize(nor - float3( 0. , .8 , 0 )) * .5 + .5) * length( ogPos - v.pos ); //nor * .5 + .5;//float3(float(fID)/32768., v.uv.x , v.uv.y);
                return o;
            }
            ...
            float4 frag (varyings i) : COLOR {
                ...
                return float4( i.debug * .5 , 1.0 );//.1 * float4(1,0.5f,0.0f,1.0) / ( i.dToPoint * i.dToPoint  * i.dToPoint );
            }
